...
import { FileKey, FileText, Eye, EyeOff, Download, Trash2, Copy, Check, Pencil } from 'lucide-react'
...
export default function VaultItemCard({ item, vaultKey, token, onDeleted, onUpdated }: Props) {
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <button
              ...
              className="text-gray-600 hover:text-violet-400 p-1.5 rounded-lg hover:bg-white/5 transition-colors"
              title="Modifier"
            >
              <Pencil size={13} />
            </button>
            <button
              ...
              className="text-gray-600 hover:text-red-400 p-1.5 rounded-lg hover:bg-white/5 transition-colors"
              title="Supprimer"
            >
              <Trash2 size={13} />
            </button>
